...
export const searchData: SearchItem[] = [
  ...
  // CLAUDE.md
  {
    ...
    tag: 'Config',
    content:
      'Special markdown file for custom instructions. Claude reads it automatically for project context, coding standards, and preferences.',
    section: '#claudemd',
  },
  {
    id: 'claudemd-global',
    ...
    tag: 'Config',
    content:
      'Located at ~/.claude/CLAUDE.md. Applies to all projects. Lower priority than project-specific files.',
    section: '#claudemd',
  },
  {
    id: 'claudemd-project',
    ...
    tag: 'Config',
    content:
      'Located at .claude/CLAUDE.md or project root. Highest priority for project-specific instructions.',
    section: '#claudemd',
  },
  ...
  // Slash Commands
  {
    ...
    tag: 'Command',
    content:
      'Compress conversation context to save tokens. Summarizes while preserving important context.',
  ...
  // Hooks
  {
    ...
    tag: 'Feature',
    content:
      'Run custom scripts automatically when Claude performs actions. PreToolUse, PostToolUse, Notification, Stop.',
    section: '#hooks',
  },
  {
    id: 'pretooluse',
  ...
  // MCP Servers
  {
    ...
    tag: 'Feature',
    content:
      'Model Context Protocol servers extend Claude with external tools, databases, and APIs.',
    section: '#mcp-servers',
  },
  {
    id: 'mcp-github',
  ...
  },
  {
    ...
    tag: 'Use Case',
    content:
      'Use headless mode in GitHub Actions or other CI pipelines for automated code review.',
    section: '#headless-mode',
  },
  ...
  },
  {
    ...
    tag: 'Info',
    content:
      'Use /compact regularly, choose Haiku for simple tasks, be specific in prompts.',
    section: '#costs-performance',
  },
  ...
  // Configuration
  {
    ...
    tag: 'Config',
    content:
      'Global settings at ~/.claude/settings.json. Project settings at .claude/settings.json.',
  ...
  },
  {
    ...
    tag: 'Syntax',
    content:
      'Reference a specific file: @src/index.ts - Claude will read and understand the file.',
    section: '#mentions',
  },
  {
    id: 'mention-folder',
    ...
    tag: 'Syntax',
    content:
      'Reference entire directories: @src/components/ - Claude will explore the folder structure.',
    section: '#mentions',
  },
  {
    id: 'mention-url',
    ...
    tag: 'Syntax',
    content:
      'Reference web URLs: @https://docs.example.com - Claude will fetch and read the content.',
    section: '#mentions',
  },
  ...
  // Permissions & Safety
  {
    ...
    tag: 'Safety',
    content:
      'Claude asks for permission before file operations, bash commands, and web requests.',
    section: '#permissions',
  },
  {
    id: 'yolo-mode',
    ...
    tag: 'Mode',
    content:
      'Skip all permission prompts with --dangerously-skip-permissions. Use with caution!',
    section: '#permissions',
  },
  {
    id: 'allowed-tools',
  ...
  // Image Support
  {
    ...
    tag: 'Feature',
    content:
      'Claude can analyze images, screenshots, and diagrams for visual understanding.',
  ...
  },
  {
    ...
    tag: 'Info',
    content:
      'Debug UI issues, implement designs from mockups, understand diagrams and architecture.',
    section: '#image-support',
  },
  ...
  },
  {
    ...
    tag: 'Shortcut',
    content:
      'Use hjkl navigation, i for insert mode, Esc for normal mode, dd to delete line.',
    section: '#vim-mode',
  },
  ...
  },
  {
    ...
    tag: 'Config',
    content:
      'Create .md files in .claude/commands/ with prompts. File name becomes command name.',
    section: '#custom-commands',
  },
  {
